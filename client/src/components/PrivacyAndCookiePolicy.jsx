      ...
      <div className="govuk-grid-row">
        <div className="govuk-grid-column-two-thirds">
          ...
          <p className="govuk-body">
            ...
            performance-of-a-public-task basis to allow you to conduct your duties as a Border Force
            employee. We are also reliant on contractual processing of your data.
          </p>
          <p className="govuk-body">
          ...
          <p className="govuk-body">
            ...
            least so that updates to it can be pushed out at these times; or streamlining how pages
            are accessed based on how users click through the site.
          </p>
          <p className="govuk-body">
          ...
          <p className="govuk-body">
            COP uses both persistent and session Matomo cookies. The two types of persistent cookies
            are:
          </p>
          <ul className="govuk-list govuk-list--bullet">
            <li>
          ...
          <p className="govuk-body">
            We use the information you provide to help ensure that we can enforce access control and
            keep data secure.
          </p>
          <p className="govuk-body">
            We use information about your email and your name that we hold within the system when we
            send you a notification. We use the GOV.UK Notify service, to send you notifications
            from COP to your Home Office email address; this service is operated and assured by the
            Cabinet Office.
          </p>
          <p className="govuk-body">
            ...
            require either the subscriber’s or the user’s consent. In the case that the employer is
            the subscriber and the employee the user, consent from the employer is reasonable if the
            use of the service is necessary for the employee to fulfil their duties.
          </p>
          <p className="govuk-body">
          ...
          <p className="govuk-body">
            ...
            Force business need that will be facilitated by sharing this data. For example, we will
            share some information with Home Office Performance and Reporting Analytics Unit (PRAU)
            for MI Reporting.
          </p>
          ...
          <p className="govuk-body">
            Information captured via cookies within Matomo includes a unique visitor ID, information
            to initially identify a user when a website is visited, analytical information and
            session data temporarily stored for the visit.
          </p>
          ...
          <p className="govuk-body">
            In general, this means that we will only hold your personal data for the time you are a
            member of Border Force and then for a maximum of 5 years after you leave the Force.
          </p>
          <h2 className="govuk-heading-l">Where your data is processed and stored</h2>
          <p className="govuk-body">
            We design, build and run our systems to make sure that your data is as safe as possible
            while it is being processed or stored. We store your data on an assured platform within
            the UK.
          </p>
          <p className="govuk-body">
            ...
            Notify for a maximum of 7 days; this is stored within the European Economic Area (EEA).
          </p>
          ...
          <ul className="govuk-list govuk-list--bullet">
            ...
            <li>
              a copy of that personal data—this copy will be provided in a structured, commonly used
          ...
          <p className="govuk-body">
            If you are dissatisfied with how we respond to your request please escalate this to the
